...
class DenseNet(nn.Module):
    def __init__(self, growthRate, reduction, bottleneck, use_dropout, img_channel):
        super(DenseNet, self).__init__()
        nDenseBlocks = 16
        nChannels = 2 * growthRate
        self.conv1 = nn.Conv2d(img_channel, nChannels, kernel_size=7, padding=3, stride=2, bias=False)
